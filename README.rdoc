...
Please note that Resque Director is a very early release, with limitations, and will change over time. At the moment it is strongly not recommended for use in a production environment.
