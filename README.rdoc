...
This will run exactly what you put in the command override as a system command to start a worker, allowing you to customize the starting of a worker fully.
